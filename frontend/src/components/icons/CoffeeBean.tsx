...
export default function CoffeeBean({ className = "w-12 h-12" }: IconProps) {
    return (
      <svg 
        className={className} 
        viewBox="0 0 64 64" 
      ...
      >
        {/* 불필요한 태그와 serif:id 속성을 완벽히 제거하고 좌표만 살린 구조입니다 */}
        <g transform="matrix(1,0,0,1,-1152,-256)">
          <g id="coffee-bean-filled" fill="currentColor" transform="matrix(0.866025,0.5,-0.5,0.866025,717.879,-387.292)">
